...
class TemperatureMachine(StateMachine):
    ...
    def updateLights(self):
        ...
        # If current state cool, pulse when above target temp, stay solid when at or below target temp
        ...
        # If current state heat, pulse when below target temp, stay solid when at or above target temp
        ...
        # Any other state is off, turn off LEDs when in neither heat or cool state
        else:
            blueLight.off()
            redLight.off()
...
greenButton.when_activated = tsm.processTempStateButton
...
redButton.when_activated = tsm.processTempIncButton
...
blueButton.when_activated = tsm.processTempDecButton
