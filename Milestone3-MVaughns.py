            ...
            for word in wordList:
                ...
                for char in word:
                    ...
                    for x in morse:
                        ...
                        ## Dot or dash?
                        if (x == "."):
                            # Off state to dot state
                            self.doDot()
                            # Return to off state
                            self.doDot()
                        elif (x == '-'):
                            # Off state to dash state
                            self.doDash()
                            # Return to off state
                            self.doDash()
                        ...
                        if (morseCounter < lenMorse):
                            # If not at end of letter, increment for loop counter
                            morseCounter = morseCounter + 1
                            # Off state to dot dash pause state
                            self.doDDP()
                            # Return to off state
                            self.doDDP()
                    ...
                    if (wordCounter < lenWord):
                        # If not at end of word, increment loop counter
                        wordCounter = wordCounter + 1
                        # Off state to letter pause state
                        self.doLP()
                        # Return to off state
                        self.doLP()
                ...
                if (wordsCounter < lenWords):
                    # If not at end of message, increment for loop counter
                    wordsCounter = wordsCounter + 1
                    # Off state to word pause state
                    self.doWP()
                    # Return to off state
                    self.doWP()
